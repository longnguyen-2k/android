    ...
    Scaffold(
        ...
        content = {
            ...
            if (moveNoteToTrashDialogShownState.value) {
                AlertDialog(onDismissRequest = { moveNoteToTrashDialogShownState.value = false },
                    title = {
                        Text(text = "Move note to the trash?")
                    },
                    text = {
                        Text(text = "Are you sure want to move  this note to trash? ")
                    },
                    confirmButton = {
...
@Composable
private fun SaveNoteContent(note: NoteModel, onNoteChange: (NoteModel) -> Unit) {
    ...
    Column(modifier = Modifier.fillMaxSize()) {
        ...
        NoteCheckedOption(
            ...
            onCheckedChange = {
                val isCheckOff: Boolean? = if (canBeCheckedOff) false else null
...
@Composable
private fun NoteCheckedOption(isChecked: Boolean, onCheckedChange: (Boolean) -> Unit) {
    Row(
        Modifier
            .padding(8.dp)
            .padding(16.dp)
